...
import { mainInfo, infoTarhWithUser } from "../../newInfo";
...
describe("ثبت طرح با اعضا", () => {
  ...
  it("ثبت طرح", () => {
    ...
    cy.get(".sc-kEbfvU").click().type(infoTarhWithUser.deatils); ///// پر کردن بخش توضیخات
    cy.wait(500);
      ...
      cy.getAllLocalStorage()
        ...
        .then(() => {
          cy.request({
            ...
            body: {
              username: infoTarhWithUser.usernameHami,
              nationalCode: infoTarhWithUser.nationalCodeHami,
            },
          }).then((res) => {
