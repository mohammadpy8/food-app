...
import { mainInfo, infoTarhBaPriceSamane } from "../../newInfo";
...
describe("ثبت طرح همراه با وارد کردن هزینه سامانه", () => {
  ...
  it("ثبت طرح", () => {
    ...
    cy.get(".sc-kEbfvU").click().type(infoTarhBaPriceSamane.deatils); ///// پر کردن بخش توضیخات
    cy.wait(500);
      ...
      cy.getAllLocalStorage()
        ...
        .then(() => {
          cy.request({
            ...
            body: {
              username: infoTarhBaPriceSamane.usernameHami,
              nationalCode: infoTarhBaPriceSamane.nationalCodeHami,
            },
          }).then((res) => {
