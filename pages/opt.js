...
import styles from "../styles/optInput.module.css"; //remove this line if you are using react
...
const OTPInputGroup = () => {
  ...
  return (
    <>
      ...
      <button onClick={value}>in</button>
      <input type="text" id="one" onKeyPress={value} />
    </>
  );
};
