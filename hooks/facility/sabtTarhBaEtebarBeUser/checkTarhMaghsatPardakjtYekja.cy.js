...
import { mainInfo, checkInfoBaAghsat, infoTrahBaUser } from "../../../info";
import { gettingHami } from "../../../utils";

describe("چک کردن در پرداخت یکجا در طرح با دادن مبلغ به هر درخواست فقط", () => {
  let token;
        ...
        .then(() => {
          cy.request({
            ...
            headers: {
              ...
              gatewayToken: "90375b4f-2be6-4966-b6ab-eb56569c1bfc",
            },
            body: {
              monthCount: 10,
              prePaymentAmount: 0,
