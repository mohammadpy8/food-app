...
import { bodyCheckTarh, bodyCheckNotTarh, gettingHami } from "../../../utils";
import { checkUserMhami, password } from "../../../info";
        ...
        .then(() => {
          ...
          cy.then(() => {
            ...
            cy.request({
              ...
              const HamiList = res.body.haamiModelList;
              return gettingHami(HamiList, "رزگار حسین");
            });
            cy.end();
          });
        });
