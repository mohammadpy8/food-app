...
import { password, checkMhami } from "../../../info";
import {
  checkPrice,
  finallPriceAghsat,
  checkValueMaghsat,
...
describe("ورود به ام حامی", () => {
  ...
  it.only("", () => {
    const hamiii = [
      { fullName: "jjjjj", age: 10 },
      { fullName: "lllll", age: 10 },
      { fullName: "nnnnn", age: 10 },
      { fullName: "mmmmm", age: 10 },
      { fullName: "ooooo", age: 10 },
    ];
    // const checking = checkValueMaghsat(500000, 500000, 42, 0.001);
    // console.log(checking[0] - Math.floor(checking[0]));
    // const price = finallPriceAghsat(checking[0]);
    // console.log(price);
    console.log(gettingHami(hamiii, "ooooo"));
  });
});
